...
class EstudianteRudealController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        return $this->render('SiePermanenteBundle:EstudianteRudeal:index.html.twig', [
            'sie'=>$sie,
    ...
    public function diversaAction(Request $request){
        ...
        return $this->render('SiePermanenteBundle:EstudianteRudeal:diversa.html.twig', array(
            'diversa'=>$diversa,
