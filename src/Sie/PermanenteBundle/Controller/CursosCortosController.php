    ...
    public function newCursoCortoAction(Request $request){
        ...
        try {
            ...
            $form = $this->createFormBuilder()
                ...
                ->add('horas', 'text', array( 'required' => true, 'attr' => array('class' => 'form-control','enabled' => true, 'pattern' => '[0-9]','onblur'=>'rangosHorasCC(this)')))
        ...
        ');
          ...
          //  dump($institucioncursocorto->getPoblacionTipo()->getId());die;
            ...
            $form = $this->createFormBuilder()
                ...
                ->add('horas', 'text', array( 'required' => true, 'data' => $institucioncurso->getDuracionhoras(), 'attr' => array('autocomplete' => 'off', 'class' => 'form-control', 'pattern' => '[0-9]','onblur'=>'rangosHorasCC(this)')))
