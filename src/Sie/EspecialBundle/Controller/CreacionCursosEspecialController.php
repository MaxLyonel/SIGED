...
//             				}
            ...
            $form = $this->createFormBuilder()
                    ...
                    ->add('modalidad','choice',array('label'=>'Modalidad','choices'=>array(1=>'DIRECTA',2=>'INDIRECTA'),'empty_value' => 'Seleccionar','required' => true, 'attr' => array('class' => 'form-control'),'attr'=>array('class'=>'form-control')))
                ...
                */
                ...
                if (isset($form['educacionCasa']) and $form['educacionCasa'] == 1){
                    ...
                    if(isset($form['multiple']) and $form['multiple'] != 'Otro'){
                        ...
                        $lugar="EDUCACION EN CASA" . '-' . $form['fisicoMotor'];
                    }else {
                        $lugar="EDUCACION EN CASA";
                    }
                    ...
                    $modalidad = 2;
                }elseif(($form['area'] == 3 or $form['area'] == 5) and $form['servicio'] == 20){
                    $modalidad = 2;
