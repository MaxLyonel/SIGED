 ...
 *
 */
class InfoMaestroEspecialController extends Controller {
    ...
    public function indexAction(Request $request, $op) {
    	try {
    		...
    		switch ($tipoSistema) {
    			case 'REGULAR': $this->session->set('tituloTipo', 'Maestro(s)');
    		...
    		if ($request->getMethod() == 'POST') { // si los valores fueron enviados desde el formulario
    			...
    			if (!$institucioneducativa) {
    				...
    				return $this->render('SieEspecialBundle:InfoMaestroEspecial:search_ie.html.twig', array('form' => $this->formSearch($request->getSession()->get('currentyear'))->createView()));
    			}
    			/*
...
//     		$query = $em->createQuery(
//     				'SELECT mi, per, ft, icom FROM SieAppWebBundle:InstitucioneducativaCursoOfertaMaestro icom
//                         JOIN icom.maestroInscripcion mi
//                         JOIN mi.persona per
...
//     		                        $maestro = $query->getResult();
                            ...
                            return $this->render('SieEspecialBundle:InfoMaestroEspecial:index.html.twig', array(
                            		'maestro' => $maestro,
    ...
    private function formSearch($gestionactual) {
    	try {
    		...
    		->setAction($this->generateUrl('info_maestro_especial_index'))
    ...
    public function findAction(Request $request) {
        ...
        return $this->render('SieEspecialBundle:InfoMaestroEspecial:search.html.twig', array(
    ...
    public function resultAction(Request $request) {
        ...
        $institucion = $em->getRepository('SieAppWebBundle:Institucioneducativa')->find($request->getSession()->get('idInstitucion'));
        //dump($personas);die;
        return $this->render('SieEspecialBundle:InfoMaestroEspecial:result.html.twig', array(
                    'personas' => $personas,
                    'institucion' => $institucion,
                    'gestion' => $request->getSession()->get('idGestion')
        ));
    ...
    private function searchForm() {
        $form = $this->createFormBuilder()
                ->setAction($this->generateUrl('info_maestro_especial_result'))
                ...
                ->add('buscar', 'submit', array('label' => 'Buscar coincidencias por C.I.', 'attr' => array('class' => 'btn btn-facebook')))
                ->getForm();
        return $form;
    }
    ...
    public function newAction(Request $request) {
        ...
        return $this->render('SieEspecialBundle:InfoMaestroEspecial:new.html.twig', array(
    ...
    public function editAction(Request $request) {
        ...
        return $this->render('SieEspecialBundle:InfoMaestroEspecial:edit.html.twig', array(
    ...
    private function newForm($idInstitucion, $gestion, $idPersona) {
        ...
        $form = $this->createFormBuilder()
                ->setAction($this->generateUrl('info_maestro_especial_create'))
    ...
    private function editForm($idInstitucion, $gestion, $persona, $maestroInscripcion, $idiomas) {
        ...
        $form = $this->createFormBuilder()
                ->setAction($this->generateUrl('info_maestro_especial_update'))
                ->add('institucionEducativa', 'hidden', array('data' => $idInstitucion))
                ->add('gestion', 'hidden', array('data' => $gestion))
    ...
    public function createAction(Request $request) {
        ...
        try {
            ...
            if ($maestroInscripcion) { // Si  el personalAdministrativo ya esta inscrito
                ...
                return $this->redirect($this->generateUrl('info_maestro_especial_index',array('op'=>'result')));
            }
