...
class MaestrosController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        $docentes = $em->getRepository('SieAppWebBundle:MaestroInscripcion')->getListaDocentes($this->session->get('ie_id'),$this->session->get('ie_gestion'),$this->session->get('ie_suc_id'),$this->session->get('ie_per_cod'));
        
        return $this->render('SieHerramientaAlternativaBundle:Maestros:index.html.twig', array(
                    'maestros' => $docentes
        ));
    }
    ...
    public function editAction(Request $request) {
        ...
        return $this->render('SieHerramientaAlternativaBundle:Maestros:edit.html.twig', array(
