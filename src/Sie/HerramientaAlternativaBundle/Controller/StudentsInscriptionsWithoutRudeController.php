...
class StudentsInscriptionsWithoutRudeController extends Controller {
    ...
    public function indexAction(Request $request){
        ...
        return $this->render('SieHerramientaAlternativaBundle:StudentsInscriptionsWithoutRude:lookforstudent.html.twig', array(
    ...
    **/
    private function findStudentForm($data){
      ...
      $form = $this->createFormBuilder()
              ...
              ->add('localidad', 'text', array('data' => '', 'required' => false, 'mapped' => false, 'label' => 'Localidad', 'attr' => array('style' => 'text-transform:uppercase', 'class' => 'form-control')))
