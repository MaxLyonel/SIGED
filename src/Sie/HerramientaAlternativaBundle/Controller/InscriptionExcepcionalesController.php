...
/**
 * InscriptionExcepcionales controller.
 *
 */
class InscriptionExcepcionalesController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        //draw the form
        return $this->render($this->session->get('pathSystem') . ':InscriptionExcepcionales:index.html.twig', array(
                    'form' => $this->formSearchStudent()->createView(),
        ));
    }
    /**
    * build the find student form
    */
    private function formSearchStudent(){
    ...
    public function resultAction(Request $request){
      ...
      if($objStudent){
        ...
        if($objStudentInscriptions){
          ...
          return $this->render($this->session->get('pathSystem') . ':InscriptionExcepcionales:result.html.twig', array(
    ...
    */
    private function createFormInscription($data, $objStudentInscriptions, $currentLevelStudent){
      ...
      return $form = $this->createFormBuilder()
              ->setAction($this->generateUrl('alternativa_inscriptionExcepcionales_saveExcepcionales'))
              ...
              ->add('semestre', 'choice', array('mapped' => false, 'label' => 'Semestre', 'choices' => array(''=>'','1' => '1', '2' => '2'), 'attr' => array('class' => 'form-control')))
              ...
              ->add('nivelId', 'hidden', array('mapped' => false, 'data' => $nivelId))
              ->add('cicloId', 'hidden', array('mapped' => false, 'data' => $cicloId))
              ->add('gradoId', 'hidden', array('mapped' => false, 'data' => $gradoId))
    ...
    */
     ...
     * @return type
     */
    public function findIEAction($id, $nivel, $ciclo, $grado, $gestion) {
        ...
        if ($ue) {
            if (!$aTuicion[0]['get_ue_tuicion']) {
                    ...
                    foreach ($infoQuerySuc as $info) {
                        $arrSubCea[$info['subCeaId']] = $info['sucursalTipo'];
                    }
        ...
        return $response->setData(array('nombre' => $nombreIE, 'paralelo' => $paralelo, 'turno' => $turno, 'arrsubcea'=>$arrSubCea));
    }
     ...
     * @return type
     */
    public function findturnoAction($paralelo, $sie, $nivel,$ciclo, $grado, $gestion) {
        $em = $this->getDoctrine()->getManager();
//get grado
        $aturnos = array();
...
//          die;
    ...
    */
    public function withoutRudeExcepcionalAction(Request $request){
      return $this->render($this->session->get('pathSystem') . ':InscriptionExcepcionales:withoutrude.html.twig', array(
    ...
    */
    public function searchStudentsAction (Request $request){
      ...
      return $this->render($this->session->get('pathSystem') . ':InscriptionExcepcionales:resultnorude.html.twig', array(
                  'newstudent' => $form,
    ...
    */
    public function newExcepcionalAction(Request $request) {
        ...
        return $this->render($this->session->get('pathSystem') . ':InscriptionExcepcionales:newexcepcional.html.twig', array(
                    'datastudent' => $form,
