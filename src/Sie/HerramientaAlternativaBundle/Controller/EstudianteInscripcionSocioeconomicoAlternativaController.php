        ...
        $form = $this->createFormBuilder()
         ...
         //   ->add('seccioniiUnidadMilitarTipo', 'choice', array('required' => false, 'choices' => $unidadMilitarTipoArray, 'empty_value' => 'Seleccionar...', 'attr' => array('class' => 'form-control')))
           ...
           $form=$form
            ...
            ->add('seccioniiiTelefonofijo', 'text', array('required' => false, 'attr' => array('class' => 'form-control', 'pattern' => '[0-9]{0,7}', 'maxlength' => '13')))
            ->add('seccioniiiTelefonocelular', 'text', array('required' => false, 'attr' => array('class' => 'form-control', 'pattern' => '[0-9]{0,8}', 'maxlength' => '13')))
...
//findBy(array(),array('name' => 'ASC'));
 ...
 /*idiomas*/
        ...
        $form = $this->createFormBuilder()
            ...
            ->add('seccioniiiTelefonofijo', 'text', array('data' => $socioeconomico->getSeccioniiiTelefonofijo(), 'required' => false, 'attr' => array('class' => 'form-control', 'pattern' => '[0-9]{0,7}', 'maxlength' => '13')))
            ->add('seccioniiiTelefonocelular', 'text', array('data' => $socioeconomico->getSeccioniiiTelefonocelular(), 'required' => false, 'attr' => array('class' => 'form-control', 'pattern' => '[0-9]{0,8}', 'maxlength' => '13')))
