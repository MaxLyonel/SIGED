 ...
 *
 */
class PrevImmediateModiController extends Controller{
    ...
    public function index1Action(){
        ...
        return $this->render('SieProcesosBundle:PrevImmediateModi:index.html.twig', array(
                // ...
            ));    
    }
    ...
    public function buscarCalificacionesAction(Request $request){
        ...
        // return $this->render('SieProcesosBundle:PrevImmediateModi:formulario.html.twig', array(
    ...
    public function formularioVistaImprimirLibretaAction(Request $request){
        try {
            ...
            return $this->render('SieProcesosBundle:PrevImmediateModi:formularioVistaImprimirLibreta.html.twig', array(
                'historial'=>$historial,
                'datos'=>$datosNotas,
                'idTramite'=>$idTramite,
                'idInscripcion' => $idInscripcion,
...
//dump($this->historial($idTramite));die;
    ...
    public function derivaVerificaDistritoAction(Request $request){
        try {
            $em = $this->getDoctrine()->getManager();
            $em->getConnection()->beginTransaction();
