...
class InstitucionalizacionDgesttlaController extends Controller
{
    ...
    public function createRegistroNuevoForm()
    {
        ...
        $form=$form
            ...
            ->add('carnet','text',array('label'=>'Carnet de Identidad:','required'=>true,'attr' => array('class' => 'form-control','style' => 'text-transform:uppercase','autocomplete' => 'off', 'maxlength' => '15')))
            ->add('complemento','text',array('label'=>'Complemento:','required'=>false,'attr' => array('class' => 'form-control','style' => 'text-transform:uppercase','autocomplete' => 'off', 'maxlength' => '2')))
            ->add('paterno','text',array('label'=>'Apellido Paterno:','required'=>false,'attr' => array('class' => 'form-control','style' => 'text-transform:uppercase','autocomplete' => 'off', 'maxlength' => '100')))
            ->add('materno','text',array('label'=>'Apellido Materno:','required'=>false,'attr' => array('class' => 'form-control','style' => 'text-transform:uppercase','autocomplete' => 'off', 'maxlength' => '100')))
            ->add('nombre','text',array('label'=>'Nombre(s):','required'=>true,'attr' => array('class' => 'form-control','style' => 'text-transform:uppercase','autocomplete' => 'off', 'maxlength' => '180')))
            ->add('apellidoEsposo','text',array('label'=>'Apellido de casada:','required'=>false,'attr' => array('class' => 'form-control','style' => 'text-transform:uppercase','autocomplete' => 'off', 'maxlength' => '100')))
            ->add('nacionalidad','text',array('label'=>'Nacionalidad:','required'=>true,'attr' => array('class' => 'form-control','style' => 'text-transform:uppercase', 'maxlength' => '100','autocomplete' => 'off')))
            ->add('genero', 'choice', array('label' => 'Género:', 'required' => true, 'choices' => [1 => 'Masculino', 2 => 'Femenino', 3 => 'Otro']))
            ->add('fechaNacimiento', 'date', array('label' => 'Fecha de nacimiento:', 'widget' => 'single_text','format' => 'dd-mm-yyyy', 'required' => true, 'attr' => array('class' => 'form-control','autocomplete' => 'off')))
            ->add('direccion', 'text', array('label' => 'Dirección actual:','required'=>true,'attr' => array('class' => 'form-control','style' => 'text-transform:uppercase', 'maxlength' => '200','autocomplete' => 'off')))
            ->add('telefono', 'text', array('label' => 'Telefono fijo:','required'=>false,'attr' => array('class' => 'form-control validar', 'maxlength' => '10','autocomplete' => 'off')))
            ->add('celular', 'text', array('label' => 'Telefono celular:','required'=>true,'attr' => array('class' => 'form-control validar', 'maxlength' => '10','autocomplete' => 'off')))
            ->add('correoElectronico', 'text', array('label' => 'Correo Electrónico:','required'=>true,'attr' => array('class' => 'form-control', 'maxlength' => '100','autocomplete' => 'off')))
            ->add('licenciatura', 'text', array('label' => 'Licenciatura en:','required'=>false,'attr' => array('class' => 'form-control', 'maxlength' => '200','autocomplete' => 'off')))
            ->add('tecnicoSuperior', 'text', array('label' => 'Técnico Superior en:','required'=>false,'attr' => array('class' => 'form-control', 'maxlength' => '200','autocomplete' => 'off')))
            ->add('tipoPostgrado', 'choice', array('label' => 'Postgrado', 'required' => false, 'choices' => [1 => 'Diplomado', 2 => 'Especialidad', 3 => 'Maestría', 4 => 'Doctorado']))
            ->add('postgrado', 'textarea', array('label' => 'Post Grado:','required'=>false,'attr' => array('class' => 'form-control', 'maxlength' => '400','autocomplete' => 'off')))
    ...
    public function registroNuevoAction($request) {
        dump($request);die;
    }
