...
class DownloadController extends Controller {
    ...
    public function downloadLibretaAction(Request $request) {
        ...
        if($this->session->get('ue_tecteg') == false){
            ...
            if($gestion == 2021){
                switch ($nivel) {
                    case 11: $reporte = 'reg_est_LibretaEscolar_inicial_v1_eea.rptdesign'; break;
                    case 12: $reporte = 'reg_est_LibretaEscolar_primaria_v2_eea.rptdesign'; break;
                    case 13: $reporte = 'reg_est_LibretaEscolar_secundaria_v2_eea.rptdesign'; break;
                }
            }else{
                if($gestion == 2019){
        ...
        if($gestion == 2021){
            dump(($this->container->getParameter('urlreportweb').$reporte.'&inscripid=' . $idInscripcion .'&codue=' . $sie .'&lk=' . $link .  '&&__format=pdf&'));
            die;
