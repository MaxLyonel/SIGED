...
class InscriptionTalentoController extends Controller {
    ...
    public function indexAction() {
        ...
        return $this->render('SieAppWebBundle:InscriptionTalento:index.html.twig', array(
    ...
    public function resultAction(Request $request) {
        ...
        if ($student) {
            //check if the student has a talento scription
//            $talentoInscription = $em->getRepository('SieAppWebBundle:EstudianteInscripcion')->findOneBy(array(
//                'estudiante' => $student->getId(),
//                'gestionTipo' => $this->session->get('currentyear'),
//                'estadomatriculaTipo' => '58'
//            ));
...
//            die;
        ...
        return $this->render('SieAppWebBundle:InscriptionTalento:result.html.twig', array(
                    'datastudent' => $student,
