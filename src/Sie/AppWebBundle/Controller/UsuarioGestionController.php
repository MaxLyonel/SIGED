...
class UsuarioGestionController extends Controller {
    ...
    public function indexAction(Request $request) {
        try{
            ...
            return $this->render('SieAppWebBundle:UsuarioGestion:index.html.twig',array('usuarios'=>$usuarios));
        } catch (Exception $ex) {
    ...
    public function editAction(Request $request){
        ...
        return $this->render('SieAppWebBundle:UsuarioGestion:edit.html.twig',array('form'=>$form->createView()));
    }
    ...
    public function activarDesactivar_usuarioAction(Request $request){
        ...
        return $this->render('SieAppWebBundle:UsuarioGestion:botonActualizar.html.twig',array('estado'=>$nuevoEstado,'idUsuarioRol'=>$usuarioRol->getId(),'div'=>$request->get('div')));
    }
}
