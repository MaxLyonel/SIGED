...
class ClaimBJPController extends Controller{
    
    public function index1Action(){
        return $this->render('SieAppWebBundle:ClaimBJP:index.html.twig', array(
                // ...
            ));    
    }
    ...
    public function buscarAction(Request $request){
        ...
        $inscripcionesEfectivas = $em->createQueryBuilder()
                            ...
                            ->andWhere('ei.estadomatriculaTipo = 5')
                            ->andWhere('gt.id = 2019')
        ...
        if (!is_object($bono)) {
            ...
            $msgEstudiante = 'El estudiante si existe';
