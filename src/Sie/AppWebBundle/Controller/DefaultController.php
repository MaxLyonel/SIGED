...
//                break;
        ...
        */
        return $this->render($this->session->get('pathSystem') . ':Login:login.html.twig',array(
            ...
            $this->get('request')->getSession()->get(SecurityContext::AUTHENTICATION_ERROR) // 'error'=>array('message'=>'¡Ocurrió un error interno!')
        ));
    }
