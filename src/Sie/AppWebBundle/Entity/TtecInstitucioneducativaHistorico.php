...
class TtecInstitucioneducativaHistorico
{
     ...
     * Set tipoResolucion
     *
     * @param \Sie\AppWebBundle\Entity\TtecResolucionTipo $tipoResolucion
     * @return TtecInstitucioneducativaHistorico
     */
    public function setTipoResolucion(\Sie\AppWebBundle\Entity\TtecResolucionTipo $tipoResolucion = null)
    {
