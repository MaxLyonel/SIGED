...
class BuscarPersonaTypev2 extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
            ...
            ->add('fecha_nacimiento', 'text', array("attr" => array("class" => "form-control input-sm",'maxlength' => '10','style'=>'text-transform:uppercase','onkeyup'=>'javascript:this.value=this.value.toUpperCase();'), "label_attr" => array("class" => "help-block",'id'=>'l_fecha_nacimiento'), 'label' => 'Fecha nacimiento :', 'required' => false))
