   ...
   public function recepcionDepartamentalNuevoAction(Request $request,$id)
    {
        ...
        if($tramite->getInstitucioneducativa()){
            ...
            return $this->render('SieHerramientaBundle:TramiteRue:recepcionDepartamentalModificacion.html.twig', array(
    ...
    public function analisisTecnicoMineduNuevoAction(Request $request,$id)
    {
        ...
        return $this->render('SieHerramientaBundle:TramiteRue:analisisTecnicoMineduNuevo.html.twig', array(
    ...
    public function obtieneDatos($wfdatos)
    {
        ...
        foreach($wfdatos as $wfd)
        {
            ...
            switch ($wfd->getTramiteDetalle()->getFlujoProceso()->getId()) {
                case 39:
                    $tarea39['idrue'] = $datos['idrue'];
                    $tarea39['institucioneducativa'] = $datos['institucionEducativa'];
                    $tarea39['tramitetipo'] = $em->getRepository('SieAppWebBundle:TramiteTipo')->find($datos['tramitetipo'])->getTramiteTipo();
                    $tarea39['tipoeducacion'] = $em->getRepository('SieAppWebBundle:InstitucioneducativaTipo')->find($datos['tipoeducacion'])->getDescripcion();
                    $tarea39['dependenciatipo'] = $em->getRepository('SieAppWebBundle:DependenciaTipo')->find($datos['dependenciaTipo'])->getDependencia();
                    $tarea39['observacion'] = $datos['observacion'];
                    $tarea39['requisitos'] = $datos['requisitos'];
                    //dump($tarea39);die;
                    $tareasDatos[] = array('flujoProceso'=>39,'datos'=>$tarea39);
                    //dump($tareas);die;
                    break;
                case 40:
                    //dump($datos);die;
                    $tarea40['informe'] = $datos['informe'];
                    $tarea40['fechainforme'] = $datos['fechainforme'];
                    $tarea40['observacion'] = $datos['observacion'];
                    $tareasDatos[] = array('flujoProceso'=>40,'datos'=>$tarea40);
                    break;
                case 41:
                    //dump($datos);die;
                    $tarea41['tipotramite'] = $wfd->getTramiteDetalle()->getTramite()->getTramiteTipo();
                    $tarea41['turno'] = $em->getRepository('SieAppWebBundle:TurnoTipo')->find($datos['turnotipo'])->getTurno();
                    $tarea41['participantes'] = '';
                    $tarea41['areaespecial'] = '';
                    $tarea41['resolucion'] = '';
                    $tarea41['iiia_acta'] = '';
                    if ($wfd->getTramiteDetalle()->getTramite()->getInstitucioneducativa()){  //si es modificacion
                        ...
                        //dump($le);die;
                        $tarea41['tipoeducacion'] = $em->getRepository('SieAppWebBundle:InstitucioneducativaTipo')->find($datos['institucioneducativa']['institucioneducativa_tipo_id'])->getDescripcion();
                        $tarea41['dependenciatipo'] = $em->getRepository('SieAppWebBundle:DependenciaTipo')->find($datos['institucioneducativa']['dependencia_tipo_id'])->getDependencia();
                        $tarea41['niveltipo'] = $em->getRepository('SieAppWebBundle:InstitucioneducativaNivelAutorizado')->findBy(array('institucioneducativa'=>$datos['institucioneducativa']['id']));
                        $tarea41['le'] = $datos['jurisdiccion_geografica']['id'];
                        $tarea41['departamento'] = $le->getLugarTipo()->getLugarTipo()->getLugarTipo()->getLugarTipo()->getLugar();
                        $tarea41['provincia'] = $le->getLugarTipo()->getLugarTipo()->getLugarTipo()->getLugar();
                        $tarea41['municipio'] = $le->getLugarTipo()->getLugarTipo()->getLugar();
                        $tarea41['canton'] = $le->getLugarTipo()->getLugar();
                        $tarea41['localidad'] = $le->getLugar();
                        $tarea41['distrito'] = $em->getRepository('SieAppWebBundle:DistritoTipo')->find($datos['jurisdiccion_geografica']['distrito_tipo_id'])->getDistrito();
                        $tarea41['codrue'] = $datos['institucioneducativa']['id'];
                        $tarea41['institucioneducativa'] = $datos['institucioneducativa']['institucioneducativa'];
                        $tarea41['resolucion'] = $wfd->getTramiteDetalle()->getTramite()->getInstitucioneducativa()->getNroResolucion();
                        $tarea41['zona'] = $datos['jurisdiccion_geografica']['zona'];
                        $tarea41['direccion'] = $datos['jurisdiccion_geografica']['direccion'];
                        if($datos['institucioneducativa']['institucioneducativa_tipo_id']==4){
                            $tarea41['areaespecial'] = $em->getRepository('SieAppWebBundle:InstitucioneducativaAreaEspecialAutorizado')->findBy(array('institucioneducativa'=>$datos['institucioneducativa']['id'])); 
                        ...
                        $tarea41['tipoeducacion'] = $em->getRepository('SieAppWebBundle:InstitucioneducativaTipo')->find($datos['tipoeducacion'])->getDescripcion();
                        $tarea41['dependenciatipo'] = $em->getRepository('SieAppWebBundle:DependenciaTipo')->find($datos['dependenciatipo'])->getDependencia();
                        $tarea41['niveltipo'] = $em->getRepository('SieAppWebBundle:NivelTipo')->findBy(array('id'=>$datos['niveltipo']));
                        $tarea41['le'] = $datos['lejurisdiccion'];
                        $tarea41['codrue'] = '';
                        $tarea41['departamento'] = $em->getRepository('SieAppWebBundle:DepartamentoTipo')->find($datos['departamento'])->getDepartamento();
                        $tarea41['provincia'] = $em->getRepository('SieAppWebBundle:LugarTipo')->find($datos['provincia'])->getLugar();
                        $tarea41['municipio'] = $em->getRepository('SieAppWebBundle:LugarTipo')->find($datos['municipio'])->getLugar();
                        $tarea41['canton'] = $em->getRepository('SieAppWebBundle:LugarTipo')->find($datos['canton'])->getLugar();
                        $tarea41['localidad'] = $em->getRepository('SieAppWebBundle:LugarTipo')->find($datos['localidad'])->getLugar();
                        $tarea41['distrito'] = $em->getRepository('SieAppWebBundle:DistritoTipo')->find($datos['distrito'])->getDistrito();
                        $tarea41['institucioneducativa'] = $datos['institucioneducativa'];
                        $tarea41['zona'] = $datos['zona'];
                        $tarea41['direccion'] = $datos['direccion'];
                    ...
                    $tarea41 = array_merge($tarea41, $datos); 
                    //dump($tarea41);die;
                    $tareasDatos[] = array('flujoProceso'=>41,'datos'=>$tarea41);
                    break;
                case 42:
                    //dump($datos);die;
                    $tareasDatos[] = array('flujoProceso'=>42,'datos'=>$datos);
                    break;
                case 44:
                    //dump($datos);die;
                    $tareasDatos[] = array('flujoProceso'=>44,'datos'=>$datos);
                    break;
                case 47:
                    //dump($datos);die;
                    if($datos['varevaluacion'] == "SI"){
                        $tarea47['resolucion'] = $datos['resolucion'];
                        $tarea47['fecharesolucion'] = $datos['fecharesolucion'];
                        $tarea47['institucioneducativa'] = $datos['institucioneducativa'];
                        $tarea47['lejurisdiccion'] = $datos['lejurisdiccion'];
                        $tarea47['departamento'] = $em->getRepository('SieAppWebBundle:LugarTipo')->find($datos['departamento'])->getLugar();
                        ...
                        $tarea47['dependencia'] = $em->getRepository('SieAppWebBundle:DependenciaTipo')->find($datos['dependencia'])->getDependencia();
                        ...
                        $tarea47['tipobachillerato'] = $datos['tipobachillerato'];
                        $tarea47['comparteLe'] = $datos['comparteLe'];
                        $tarea47['formularios'] = $datos['formularios'];
                        $tarea47['varevaluacion'] = $datos['varevaluacion'];
                        $tarea47['observacion'] = $datos['observacion'];
                        if($datos['tipoeducacion'] == 4){
                            $tarea47['areaEspecialTipo'] = $em->getRepository('SieAppWebBundle:EspecialAreaTipo')->findBy(array('id'=>$datos['areaEspecialTipo'])); 
                        }
                        if ($wfd->getTramiteDetalle()->getTramite()->getInstitucioneducativa()){  //si es modificacion
                            $tarea47['idrue'] = $datos['idrue'];
                        }else{
                            $tarea47['idrue'] = "";
                            $tarea47['director'] = $datos['director'];
                            $tarea47['ci'] = $datos['ci'];
                            $tarea47['tienecargo'] = $datos['tienecargo'];
                            $tarea47['telefono'] = $datos['telefono'];
                            $tarea47['otrotelefono'] = $datos['otrotelefono'];
                            $tarea47['email'] = $datos['email'];
                            $tarea47['fax'] = $datos['fax'];
                            $tarea47['otropertenece'] = $datos['otropertenece'];
                            $tarea47['casilla'] = $datos['casilla'];
                        }
                        $tareasDatos[] = array('flujoProceso'=>47,'datos'=>$tarea47);
                    }else{
                        $tareasDatos[] = array('flujoProceso'=>47,'datos'=>$datos);
                    }
                    //dump($tarea47);die;
                    break;
                ...
                case 49:
                    //dump($datos);die;
                    $tareasDatos[] = array('flujoProceso'=>48,'datos'=>$datos);
                    break;
                case 50:
                    break;
            }
