...
/**
 * TramiteGPAreasEstudianteController
 *
 */
class TramiteGPAreasEstudianteController extends Controller
{
    public $session;
    public $iddep;
    public $idprov;
    ...
    /***
     * Formulario inicio de solicitud areas-estudiante
     */
    public function inicioSolicitudAreasEstudianteAction(Request $request)
    {
        ...
        if($tipo =='idtramite'){
            ...
            if($tramite){
                $request->getSession()->getFlashBag()->add('error', 'La Unidad Educativa ya cuenta con una SOLICITUD DE ADICIÓN/ELIMINACIÓN DE ÁREAS en la gestión actual con el <strong>Nro.: '.$tramite->getId().'</strong></br>Para iniciar un nuevo trámite primero debe finalizar el actual.');
        ...
        return $this->render('SieHerramientaBundle:TramiteGPAreasEstudiante:inicioSolicitudModificacion.html.twig', array(
