...
class TramiteAceleraController extends Controller
{
    ...
    public function newAction(Request $request) {
        ...
        return $this->render('SieHerramientaBundle:TramiteAcelera:new.html.twig', array('centro_inscripcion' => $centro_inscripcion, 'centro' => $centro, 'flujotipo_id' => $flujotipo_id));
    }
