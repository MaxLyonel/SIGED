...
class StudentsInscriptionSeguimientoController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        return $this->render($this->session->get('pathSystem') . ':StudentsInscriptionSeguimiento:index.html.twig', array(
    ...
    private function craeteformsearchsie() {
        ...
        return $this->createFormBuilder()
                        ->setAction($this->generateUrl('students_inscriptions_seguimiento_find'))
    ...
    public function findAction(Request $request) {
        ...
        if ($request->isMethod('POST')) {
            ...
            $numberStudents = $em->getRepository('SieAppWebBundle:Institucioneducativa')->getInscriptionSegPerUe($form['sie'], $form['gestion']);

        //    dump($numberStudents);DIE;
            $message = "Resultado de la Busqueda...";
            $this->addFlash('successsi1', $message);
            return $this->render($this->session->get('pathSystem') . ':StudentsInscriptionSeguimiento:find.html.twig', array(
    ...
    public function openhistoricAction(Request $requerst, $sie, $gestion, $nivel, $grado, $paralelo, $turno) {
        ...
        $objStudents = $em->getRepository('SieAppWebBundle:Institucioneducativa')->getListStudentPerCourseSeg($sie, $gestion, $nivel, $grado, $paralelo, $turno);
       // dump($objStudents);DIE;
        return $this->render($this->session->get('pathSystem') . ':StudentsInscriptionSeguimiento:listStudents.html.twig', array(
