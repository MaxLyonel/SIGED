...
class DownloadFileSieAcaController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        */
        ...
        return $this->render($this->session->get('pathSystem') . ':DownloadFileSieAca:index.html.twig', array(
    ...
    private function craeteformsearchsie() {
        return $this->createFormBuilder()
                        ->setAction($this->generateUrl('download_file_aca_sie_build'))
         ...
         try {
           ...
           * *
           ...
           if($objUe[0]['tipoUe']!=1){
             ...
             $objObservados = array();
             return $this->render($this->session->get('pathSystem') . ':DownloadFileSieAca:fileDownload.html.twig', array(
 ...
 //                ftp_close($conn);
    ...
    public function buildOldAction(Request $request) {
...
//        }
    ...
    public function getbimestreAction($sie, $gestion) {
        ...
        $aBimestre = ($this->session->get('roluser') != 8) ? ($aBimestre) ? $aBimestre : array() : array('0' => 'IG', '1' => '1ro', '2' => '2do', '3' => '3ro', '4' => '4to');
