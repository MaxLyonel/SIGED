...
class ReporteController extends Controller {
    ...
    public function diplomaBachillerNivelDepartamental($depto, $gestion) {
        ...
        $query = $em->getConnection()->prepare("
                ...
                WHERE iec.gestion_tipo_id = ".$gestion." and d.documento_estado_id = 1 and documento_tipo_id = 1 and iec.nivel_tipo_id in (3,5,13,15) and lt4.codigo = '".$depto."'
    ...
    public function diplomaBachillerNivelDistrital($distrito, $gestion) {
        ...
        $query = $em->getConnection()->prepare("
                ...
                left join lugar_tipo as lt4 on lt4.id = lt3.lugar_tipo_id
                left join lugar_tipo as lt5 on lt5.id = jg.lugar_tipo_id_distrito
                WHERE iec.gestion_tipo_id  = ".$gestion." and d.documento_estado_id = 1 and documento_tipo_id = 1 and iec.nivel_tipo_id in (3,5,13,15) and lt5.id = '".$distrito."'
                group by /*lt5.id, lt5.id, */ie.id, iec.nivel_tipo_id
                ) as v
    ...
    public function diplomaBachillerNivelInstitucional($ue, $gestion) {
        ...
        $query = $em->getConnection()->prepare("
                ...
                left join lugar_tipo as lt4 on lt4.id = lt3.lugar_tipo_id
                left join lugar_tipo as lt5 on lt5.id = jg.lugar_tipo_id_distrito
                WHERE iec.gestion_tipo_id = ".$gestion." and d.documento_estado_id = 1 and documento_tipo_id = 1 and iec.nivel_tipo_id in (3,5,13,15) and ie.id = ".$ue."
                ) as v
