 ...
 *
 */
class TerminarPagosBonoController extends Controller {
      ...
      if ($contador == 0)
      {
            ...
            $query1 = $consultaAsig1->createQueryBuilder('instedu')
              ...
              //    $contador = 0;
                  ...
                  {
                    $sieArray1[$value->getId()] = $value->getInstitucioneducativa() + ' ' + $value->getCodSie() ;;
                    $contador = $contador + 1;
                    //echo '<script language="javascript">alert("'.$contador.'");</script>';
                  }
                  return $this->render('SieBjpBundle:TerminarPagosBono:index.html.twig', array(
             'form' => $this->seleccionUeForm($sieArray1)->createView()));

      }
      //dump($sieArray);die;
      else{return $this->render('SieBjpBundle:TerminarPagosBono:index.html.twig', array(
    ...
    public function buscarInfoUeAction(Request $request)
    {
        ...
        return $this->render('SieBjpBundle:TerminarPagosBono:informacionUe.html.twig', array(
  ...
  public function buscarUeForm($datosUnidadEduAsignacion) {
    ...
    $datosCompleto = $datosUnidadEduAsignacion[0];
        ...
        return $this->createFormBuilder()
                    ->setAction($this->generateUrl('TerminarPagosBono_webForm'))
...
// dump($turnosArray);die;
      ...
      //     ));
          return $this->render('SieBjpBundle:TerminarPagosBono:webform.html.twig', array(
        ...
        public function lista_areas_cursoAction(Request $request) {
                ...
                $estudianteInHabilitados = $em->getRepository('SieAppWebBundle:BonojuancitoAsignacion')->getEstudiantesBono($form, 'f','f');
                  ...
                  return $this->render('SieBjpBundle:TerminarPagosBono:estudiantesbono.html.twig', array(
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        try {
            ...
            switch ($tipoSistema) {
                ...
                case 'ALTERNATIVA': $this->session->set('tituloTipo', 'Adición de Áreas y Asignacion de Docentes');
                    $this->session->set('layout', 'layoutBjp.html.twig');
                    break;
                default: $this->session->set('tituloTipo', 'TerminarPagosBono');
                    $this->session->set('layout', 'layoutBjp.html.twig');
                    break;
            }
            ...
            if ($request->getMethod() == 'POST') { // si los valores fueron enviados desde el formulario
                ...
                if ($form['gestion'] < 2008 or $form['gestion'] > 2017) {
                    ...
                    return $this->render('SieBjpBundle:TerminarPagosBono:search.html.twig', array('form' => $this->formSearch($request->getSession()->get('currentyear'))->createView()));
                }
                /**
    ...
    private function formSearch($gestionactual) {
        ...
        $form = $this->createFormBuilder()
                ->setAction($this->generateUrl('TerminarPagosBono'))
