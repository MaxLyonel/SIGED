 ...
 *
 */
class InstitucionesPagadasBonoController extends Controller {
...
dump($resultAsig);die;*/
 $consultaFuerza = $em->getRepository('SieAppWebBundle:BonojuancitoFuerzaTipo');
      ...
      // }
      //dump($sieArray);die;
      return $this->render('SieBjpBundle:InstitucionesPagadasBono:index.html.twig', array(
    ...
    private function seleccionUeForm($sieArray){
        return $this->createFormBuilder()
                    ...
                    ->add('buscar', 'button', array('label' => 'Generar Reporte', 'attr' => array('class' => 'btn btn-info btn-block', 'onclick'=>'informacionUe();')))
                    ->getForm();
