 ...
 *
 */
class ImpresionAvanceInstitucionUnidadBonoController extends Controller {
...
dump($resultAsig);die;*/
 $consultaFuerza = $em->getRepository('SieAppWebBundle:BonojuancitoFuerzaTipo');
      ...
      // }
      //dump($sieArray);die;
      return $this->render('SieBjpBundle:ImpresionAvanceInstitucionUnidadBono:index.html.twig', array(
