 ...
 *
 */
class DespachoConSupuestosBonoController extends Controller {
...
dump($resultAsig);die;*/
 $consultaFuerza = $em->getRepository('SieAppWebBundle:BonojuancitoFuerzaTipo');
      ...
      // }
      //dump($sieArray);die;
      return $this->render('SieBjpBundle:DespachoConSupuestosBono:index.html.twig', array(
    ...
    private function seleccionUeForm($sieArray){
        return $this->createFormBuilder()
              ...
              //->add('gum', 'choice', array('label' => 'Gran Unidad Militar' , 'required' => true, 'empty_value' => 'Seleccionar...', 'attr' => array('class' => 'form-control', 'onchange' => 'cargarUm()')))
                   ...
                   ->add('porcentajeactual','text', array('label'=>'Porcentaje Actual : ','attr'=>array('class'=>'form-control', 'disabled'=> true)))
                   ->add('porcentajesugerido','text', array('label'=>'Porcentaje Sugerido : ','attr'=>array('class'=>'form-control', 'disabled'=> true)))
                   ->add('porcentajeaadicionar','text', array('label'=>'Porcentaje a Adicionar  : ','attr'=>array('class'=>'form-control', 'disabled'=> true)))
                   ->add('habilitar','checkbox', array('mapped' => true,'attr'=>array('label'=>' % ','class'=>'form-control','data' => true)))
