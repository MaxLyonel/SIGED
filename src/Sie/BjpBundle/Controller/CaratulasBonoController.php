 ...
 *
 */
class CaratulasBonoController extends Controller {
...
dump($resultAsig);die;*/
 $consultaFuerza = $em->getRepository('SieAppWebBundle:BonojuancitoFuerzaTipo');
      ...
      //dump($sieArray);die;
      return $this->render('SieBjpBundle:CaratulasBono:index.html.twig', array(
    ...
    private function seleccionUeForm($sieArray){
        return $this->createFormBuilder()
                    ...
                    ->add('sie', 'choice', array('label' => 'Fuerza','required'=> false, 'empty_value' => 'Seleccionar...', 'choices' => $sieArray, 'attr' => array('class' => 'form-control')))
                    ->add('buscar', 'button', array('label' => 'Generar Caratulas', 'attr' => array('class' => 'btn btn-info btn-block', 'onclick'=>'informacionUe();')))
                    ->getForm();
