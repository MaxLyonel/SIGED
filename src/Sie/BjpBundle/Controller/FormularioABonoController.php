 ...
 *
 */
class FormularioABonoController extends Controller {
      ...
      if ($contador == 0)
      {
            ...
            $query1 = $consultaAsig1->createQueryBuilder('instedu')
              ...
              //    $contador = 0;
                  ...
                  return $this->render('SieBjpBundle:FormularioABono:index.html.twig', array(
             'form' => $this->seleccionUeForm($sieArray1)->createView()));

      }
      //dump($sieArray);die;
      else{return $this->render('SieBjpBundle:FormularioABono:index.html.twig', array(
    ...
    private function seleccionUeForm($sieArray){
        return $this->createFormBuilder()
                    ...
                    ->add('fuerza','text',array('label'=>'Introduzca los Datos del Agente Pagador Grado Nombres y Apellidos','attr'=>array('class'=>'form-control')))
                    ->add('gum','text',array('label'=>'Carnet de Identidad','attr'=>array('class'=>'form-control')))
                    ->add('buscar', 'button', array('label' => 'Buscar ', 'attr' => array('class' => 'btn btn-info btn-block', 'onclick'=>'informacionUe();')))

                    ->add('reasignar', 'button', array('label' => 'Generar Formulario A', 'attr' => array('class' => 'btn btn-info btn-block', 'onclick'=>'informacionUe();')))
...
public function cargarNivelesAction($fuerza) 
   {
    ...
    public function buscarInfoUeAction(Request $request)
    {
        ...
        return $this->render('SieBjpBundle:FormularioABono:informacionUe.html.twig', array(
  ...
  public function buscarUeForm($datosUnidadEduAsignacion) {
    ...
    $datosCompleto = $datosUnidadEduAsignacion[0];
        ...
        return $this->createFormBuilder()
                    ->setAction($this->generateUrl('FormularioABono_webForm'))
...
// dump($turnosArray);die;
      ...
      //     ));
          return $this->render('SieBjpBundle:FormularioABono:webform.html.twig', array(
        ...
        //           return $this->render('SieBjpBundle:FormularioABono:estudiantesbono.html.twig', array(
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        try {
            ...
            switch ($tipoSistema) {
                ...
                case 'ALTERNATIVA': $this->session->set('tituloTipo', 'Adición de Áreas y Asignacion de Docentes');
                    $this->session->set('layout', 'layoutBjp.html.twig');
                    break;
                default: $this->session->set('tituloTipo', 'FormularioABono');
                    $this->session->set('layout', 'layoutBjp.html.twig');
                    break;
            }
            ...
            if ($request->getMethod() == 'POST') { // si los valores fueron enviados desde el formulario
                ...
                if ($form['gestion'] < 2008 or $form['gestion'] > 2017) {
                    ...
                    return $this->render('SieBjpBundle:FormularioABono:search.html.twig', array('form' => $this->formSearch($request->getSession()->get('currentyear'))->createView()));
                }
                /**
    ...
    private function formSearch($gestionactual) {
        ...
        $form = $this->createFormBuilder()
                ->setAction($this->generateUrl('FormularioABono'))
