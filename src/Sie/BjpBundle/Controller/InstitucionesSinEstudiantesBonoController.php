 ...
 *
 */
class InstitucionesSinEstudiantesBonoController extends Controller {
...
dump($resultAsig);die;*/
 $consultaFuerza = $em->getRepository('SieAppWebBundle:BonojuancitoFuerzaTipo');
      ...
      // }
      //dump($sieArray);die;
      return $this->render('SieBjpBundle:InstitucionesSinEstudiantesBono:index.html.twig', array(
