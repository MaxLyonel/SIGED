 ...
 *
 */
class ImpresionAvanceDDepartamentoBonoController extends Controller {
...
dump($resultAsig);die;*/
 $consultaFuerza = $em->getRepository('SieAppWebBundle:BonojuancitoFuerzaTipo');
      ...
      // }
      //dump($sieArray);die;
      return $this->render('SieBjpBundle:ImpresionAvanceDDepartamentoBono:index.html.twig', array(
