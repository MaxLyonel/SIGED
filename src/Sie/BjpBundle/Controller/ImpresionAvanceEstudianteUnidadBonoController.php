 ...
 *
 */
class ImpresionAvanceEstudianteUnidadBonoController extends Controller {
...
dump($resultAsig);die;*/
 $consultaFuerza = $em->getRepository('SieAppWebBundle:BonojuancitoFuerzaTipo');
      ...
      // }
      //dump($sieArray);die;
      return $this->render('SieBjpBundle:ImpresionAvanceEstudianteUnidadBono:index.html.twig', array(
