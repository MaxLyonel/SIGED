 ...
 *
 */
class AbrirInstitucionesBonoController extends Controller {
      ...
      if ($contador == 0)
      {
            ...
            $query1 = $consultaAsig1->createQueryBuilder('instedu')
              ...
              //    $contador = 0;
                  ...
                  return $this->render('SieBjpBundle:AbrirInstitucionesBono:index.html.twig', array(
             'form' => $this->seleccionUeForm($sieArray1)->createView()));

      }
      //dump($sieArray);die;
      else{return $this->render('SieBjpBundle:AbrirInstitucionesBono:index.html.twig', array(
    ...
    public function buscarInfoUeAction(Request $request)
    {
        ...
        return $this->render('SieBjpBundle:AbrirInstitucionesBono:informacionUe.html.twig', array(
            'formUe' => $this->buscarUeForm($datosUnidadEduAsignacion)->createView(),
            'terminado' => $datosUnidadEduAsignacion[0]['esterminado'],
            'bjpaId' => $datosUnidadEduAsignacion[0]['bjpaId']
            ));
    }
    
    public function cambiarestadounidadAction($id)
    {
        $em = $this->getDoctrine()->getManager();                     
        $em->getConnection()->beginTransaction();
        $response = new JsonResponse();        
        try {
            $datosUnidadEduAsignacion = $em->getRepository('SieAppWebBundle:BonojuancitoAsignacion')->find($id);
            //dump($datosUnidadEduAsignacion);die;

            $esterminado = $datosUnidadEduAsignacion->getEsterminado();
            if  ($esterminado == true) {
                $datosUnidadEduAsignacion->setEsterminado('false');
                $mensaje = 'EN PROCESO.';
            } else {
                $datosUnidadEduAsignacion->setEsterminado('true');            
                $mensaje = 'TERMINADO';
            }
            $em->persist($datosUnidadEduAsignacion);
            $em->flush();
  ...
  public function buscarUeForm($datosUnidadEduAsignacion) {
    ...
    $datosCompleto = $datosUnidadEduAsignacion[0];
        ...
        return $this->createFormBuilder()
                    ->setAction($this->generateUrl('AbrirInstitucionesBono_webForm'))
                   ...
                   // ->add('abrir', 'submit', array('label' => 'Abrir Institucion Educativa ', 'attr' => array('class' => 'btn btn-info btn')))
...
// dump($turnosArray);die;
      ...
      //     ));
          return $this->render('SieBjpBundle:AbrirInstitucionesBono:webform.html.twig', array(
        ...
        public function lista_areas_cursoAction(Request $request) {
                ...
                $estudianteInHabilitados = $em->getRepository('SieAppWebBundle:BonojuancitoAsignacion')->getEstudiantesBono($form, 'f','f');
                  ...
                  return $this->render('SieBjpBundle:AbrirInstitucionesBono:estudiantesbono.html.twig', array(
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        try {
            ...
            switch ($tipoSistema) {
                ...
                case 'ALTERNATIVA': $this->session->set('tituloTipo', 'Adición de Áreas y Asignacion de Docentes');
                    $this->session->set('layout', 'layoutBjp.html.twig');
                    break;
                default: $this->session->set('tituloTipo', 'AbrirInstitucionesBono');
                    $this->session->set('layout', 'layoutBjp.html.twig');
                    break;
            }
            ...
            if ($request->getMethod() == 'POST') { // si los valores fueron enviados desde el formulario
                ...
                if ($form['gestion'] < 2008 or $form['gestion'] > 2017) {
                    ...
                    return $this->render('SieBjpBundle:AbrirInstitucionesBono:search.html.twig', array('form' => $this->formSearch($request->getSession()->get('currentyear'))->createView()));
                }
                /**
    ...
    private function formSearch($gestionactual) {
        ...
        $form = $this->createFormBuilder()
                ->setAction($this->generateUrl('AbrirInstitucionesBono'))
