 ...
 *
 */
class ImpresionAvanceEstudianteAreaBonoController extends Controller {
...
dump($resultAsig);die;*/
 $consultaFuerza = $em->getRepository('SieAppWebBundle:BonojuancitoFuerzaTipo');
      ...
      // }
      //dump($sieArray);die;
      return $this->render('SieBjpBundle:ImpresionAvanceEstudianteAreaBono:index.html.twig', array(
