...
class OfertaCurricularController extends Controller {
    ...
    public function indexAction(Request $request, $op) {
        ...
        try {
            ...
            switch ($tipoSistema) {
                case 'REGULAR': $this->session->set('tituloTipo', 'Gestión Oferta Curricular');
            ...
            if ($request->getMethod() == 'POST') { // si los valores fueron enviados desde el formulario
                ...
                if ($form['gestion'] != 2015) {
                    ...
                    return $this->render('SieRegularBundle:OfertaCurricular:search.html.twig', array('form' => $this->formSearch($request->getSession()->get('currentyear'))->createView()));
                }
                /*
            ...
            return $this->render('SieRegularBundle:OfertaCurricular:index.html.twig', array(
    ...
    private function formSearch($gestionactual) {
        ...
        $form = $this->createFormBuilder()
                ->setAction($this->generateUrl('oc_areas'))
    ...
    public function lista_areas_nivelAction($idNivel, $idCurso) {
        try {
            ...
            $em->getConnection()->commit();
            return $this->render('SieRegularBundle:OfertaCurricular:listaAreas.html.twig', array('areasNivel' => $areasArray, 'maestros' => $maestros));
        } catch (Exception $ex) {
            //$em->getConnection()->rollback();
        }
    }
    ...
    public function lista_areas_cursoAction(Request $request) {
        try {
            ...
            if ($form['nivel'] != 11) {
                ...
                $em->getConnection()->commit();
                return $this->render('SieRegularBundle:OfertaCurricular:listaAreasCurso.html.twig', array(
    ...
    public function lista_areas_curso_adicionar_eliminarAction(Request $request) {
        try {
            ...
            $em->getConnection()->commit();
            return $this->render('SieRegularBundle:OfertaCurricular:listaAreasCurso.html.twig', array('areasCurso' => $areasCurso, 'maestros' => $maestros, 'curso' => $curso, 'mensaje' => '','form' => $this->createFormToBuild($this->session->get('idInstitucion'), $this->session->get('idGestion'), '4')->createView()));
        } catch (Exception $ex) {
            $em->getConnection()->rollback();
        }
    }
    ...
    public function deleteAction($idCursoOferta) {
        ...
        try {
            ...
            $em->getConnection()->commit();
            return $this->render('SieRegularBundle:OfertaCurricular:listaAreasCurso.html.twig', array('areasCurso' => $areasCurso, 'maestros' => $maestros, 'curso' => $curso, 'mensaje' => $mensaje,'form' => $this->createFormToBuild($this->session->get('idInstitucion'), $this->session->get('idGestion'), '4')->createView()));
        } catch (Exception $ex) {
            $em->getConnection()->rollback();
        }
    }
    ...
    public function buildAction(Request $request) {
        ...
        try {
            ...
            return $this->render('SieRegularBundle:OfertaCurricular:fileDownload.html.twig', array(
                        'uEducativa' => $objUe[0],
