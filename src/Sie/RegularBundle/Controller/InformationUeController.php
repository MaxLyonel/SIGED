...
class InformationUeController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        return $this->render($this->session->get('pathSystem') . ':InformationUe:index.html.twig', array(
    ...
    private function craeteformsearch() {
        return $this->createFormBuilder()
                        ...
                        ->add('gestion', 'choice', array('label' => 'Gestión', 'choices' => array('2015' => '2015', '2014' => '2014'), 'attr' => array('class' => 'form-control')))
                        ->add('search', 'button', array('label' => 'Buscar', 'attr' => array('class' => 'btn btn-primary', 'onclick' => 'findInfoUe()')))
                        ->getForm();
    }
    ...
    public function resultAction(Request $request) {
        ...
        $obUe = $em->getRepository('SieAppWebBundle:Institucioneducativa')->find($form['sie']);
...
//            die;
        ...
        //render the result
        return $this->render($this->session->get('pathSystem') . ':InformationUe:result.html.twig', array(
    ...
    public function notaAction($idstudent, $nivel, $grado, $paralelo, $turno, $gestion, $sie) {
        ...
        return $this->render('SieRegularBundle:InformationUe:nota.html.twig', array(
                    'notastudent' => $aNota,
                    'bimestres' => $aBim
        ));
    }
    ...
    public function inscriptionAction($idstudent, $nivel, $grado, $paralelo, $turno, $gestion, $sie, $matricula, $ciclo) {
        ...
        return $this->render('SieRegularBundle:InformationUe:inscription.html.twig', array(
