...
class UsuarioGestionController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        try {
            ...
            $query = $em->getConnection()->prepare('SELECT get_usuario_tuicion_listado_json(:usuario::INTEGER,:rol::INTEGER,:lugar::INTEGER)');
            ...
            for ($i = 0; $i < count($usuarios); $i++) {
                $registro = json_decode($usuarios[$i]['get_usuario_tuicion_listado_json']);
                $users[] = array(
                    'usuarioRolId' => $registro->usuariorol_id,
                    'usuarioId' => $registro->usuario_id,
                    'rolTipoId' => $registro->rol_tipo_id,
                    'lugarTipoId' => $registro->lugar_tipo_id_distrito,
                    'lugar' => $registro->lugares,
                    'lugar2' => $registro->lugares2,
            ...
            return $this->render($this->session->get('pathSystem') . ':UsuarioGestion:index.html.twig', array('usuarios' => $usuarios));
        } catch (Exception $ex) {
    ...
    public function editAction(Request $request) {
        ...
        $form = $this->createFormBuilder()
                ->setAction($this->generateUrl('usuariogestion_update'))
        ...
        return $this->render($this->session->get('pathSystem') . ':UsuarioGestion:edit.html.twig', array('form' => $form->createView()));
    }
    ...
    public function activarDesactivar_usuarioAction(Request $request) {
        ...
        return $this->render($this->session->get('pathSystem') . ':UsuarioGestion:botonActualizar.html.twig', array('estado' => $nuevoEstado, 'idUsuarioRol' => $usuarioRol->getId(), 'div' => $request->get('div')));
    }
