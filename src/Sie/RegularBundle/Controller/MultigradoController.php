...
/**
 * MultigradoController Gestión de Menú Controller.
 */
class MultigradoController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        // dump($form);die;
        //get info
        $arrData['sie']     = $form['institucioneducativa'];
        $arrData['gestion'] = $form['gestion'];
        $arrData['idDetalle'] = $form['idDetalle'];
        ////////////////////////////////////////////////////////////////
...
// die;
    ...
    // dump($arrDataMultigrado);die;
      ...
      return $this->render('SieRegularBundle:Multigrado:yesMultigrado.html.twig', array(
