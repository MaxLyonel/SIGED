...
class PersonaSegipType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder            
            ...
            ->add('paterno', 'text', array('label' => 'Paterno', 'read_only' => true, 'disabled' => true, 'attr' => array('class' => 'form-control jletters','pattern' => '[a-zA-Z\sñÑáéíóúÁÉÍÓÚ]{2,45}','maxlength'=>'13','style'=>'text-transform:uppercase')))
            ->add('materno', 'text', array('label' => 'Materno', 'read_only' => true, 'disabled' => true, 'attr' => array('class' => 'form-control jletters', 'pattern' => '[a-zA-Z\sñÑáéíóúÁÉÍÓÚ]{2,45}','maxlength'=>'13','style'=>'text-transform:uppercase')))
            ->add('nombre', 'text', array('label' => 'Nombre(s)', 'read_only' => true, 'disabled' => true, 'attr' => array('class' => 'form-control jletters', 'pattern' => '[a-zA-Z\sñÑáéíóúÁÉÍÓÚ]{2,45}','maxlength'=>'26','style'=>'text-transform:uppercase')))
            ...
            ->add('carnet', 'text', array('label' => 'C.I.', 'read_only' => true, 'attr' => array('class' => 'form-control jnumbers', 'placeholder' => 'Carnet de Identidad', 'pattern' => '[0-9]{5,10}','maxlength'=>'10')))
            ->add('complemento', 'text', array('label' => 'Complemento', 'read_only' => true, 'attr' => array('class' => 'form-control jletters', 'pattern' => '[0-9]{0,2}','maxlength'=>'45','style'=>'text-transform:uppercase')))                
            ->add('fechaNacimiento', 'date', array('years' => range(date('Y') -100, date('Y')), 'label' => 'Fecha de Nacimiento', 'required' => true, 'disabled' => true, 'attr' => array('class' => 'form-control', 'placeholder' => 'dd-mm-aaaa','pattern'=>'(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}')))
