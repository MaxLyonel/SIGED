...
class PersonaSegipType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder            
            ...
            ->add('paterno', 'text', array('label' => 'Paterno', 'required' => false, 'disabled' => true, 'attr' => array('class' => 'form-control jletters','pattern' => '[a-zA-Z\sñÑáéíóúÁÉÍÓÚ]{2,45}','maxlength'=>'13','style'=>'text-transform:uppercase')))
            ->add('materno', 'text', array('label' => 'Materno', 'required' => false, 'disabled' => true, 'attr' => array('class' => 'form-control jletters', 'pattern' => '[a-zA-Z\sñÑáéíóúÁÉÍÓÚ]{2,45}','maxlength'=>'13','style'=>'text-transform:uppercase')))
            ->add('nombre', 'text', array('label' => 'Nombre(s)', 'required' => true, 'disabled' => true, 'attr' => array('class' => 'form-control jletters', 'pattern' => '[a-zA-Z\sñÑáéíóúÁÉÍÓÚ]{2,45}','maxlength'=>'26','style'=>'text-transform:uppercase')))
