var BlankonComponentTab = function () {
    ...
    return {
        ...
        componentTabs: function () {
            ...
            $('a[href="#tab15"]').on('shown.bs.tab', function () {
            ...
            $('a[href="#tab162"]').on('shown.bs.tab', function () {
                (function($, window, document, undefined) {
                    'use strict';
            ...
            $('a[href="#tab277"]').on('shown.bs.tab', function () {
                (function($, window, document, undefined) {
                    'use strict';
            ...
            $('a[href="#tab163"]').on('shown.bs.tab', function () {
                (function($, window, document, undefined) {
                    'use strict';
            ...
            $('a[href="#tab19"]').on('shown.bs.tab', function () {
                (function($, window, document, undefined) {
                    'use strict';
